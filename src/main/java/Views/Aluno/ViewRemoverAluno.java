...
public class ViewRemoverAluno {
    ...
    public ViewRemoverAluno() throws SQLException {
        verTelaRemoverAluno();
    }

    public static void verTelaRemoverAluno() throws SQLException {

        //        crio o meu Jframe
        frame = new JFrame("Remover Aluno");
...
//        e coloco a operação de fechar padrão no botão x
        ...
        btnSalvar.setActionCommand("removerAluno");
