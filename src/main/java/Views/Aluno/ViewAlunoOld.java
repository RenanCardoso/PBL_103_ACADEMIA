...
//
//public class ViewAlunoOld {
//
//    public ViewAlunoOld() throws SQLException {
//        verTelaAlunoOld();
//    }
//
//    public static void verTelaAlunoOld() throws SQLException {
//
...
//                    cliController.adicionarAluno(nome);
//                    break;
//
//                case 3:
...
//                    alunoExiste = cliController.buscarAlunoporID(alunoExiste, id);
//
...
//                         */
//                        Scanner scanNovoNomeAluno = new Scanner(System.in);
//                        String novoNomeAluno = scanNovoNomeAluno.nextLine();
////                        cliController.editarAluno(idAlunoAntigo, novoNomeAluno);
//                    } else {
...
//                    alunoExisteDelete = cliController.buscarAlunoporID(alunoExisteDelete, idDelete);
//
//                    //verifico se o retorno é diferende de nulo
//                    if (alunoExisteDelete != null){
//                        cliController.removerAluno(alunoExisteDelete);
